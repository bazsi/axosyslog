...
#define filterx_new_object(t) ((t *) filterx_malloc_object(sizeof(t), sizeof(t), #t))
#define filterx_new_object_with_extra(t, extra) ((t *) filterx_malloc_object(sizeof(t), sizeof(t) + extra, #t))
